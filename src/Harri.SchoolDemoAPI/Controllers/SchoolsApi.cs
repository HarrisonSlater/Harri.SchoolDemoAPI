...
{ 
    ...
    { 
        ...
        /// <param name="enrollment">query object to search by enrollment (lt, gt, eq)</param>
        ...
        public virtual IActionResult GetSchools([FromQuery (Name = "name")]string? name, [FromQuery (Name = "state")]State? state, [FromQuery (Name = "enrollment")]IntegerQuery? enrollment)
        {
